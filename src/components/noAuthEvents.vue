<template>
  <div class="event_main">
     <div class="overlay" v-show="overlay">
      <center>
        ...
        <h3><a href="https://mnactivist.org/donate">Donate</a></h3>
        <!--
  ...
  <el-row :gutter="24" type="flex" class="row-bg">
    <el-col :span="18" :offset="1" justify="left" style="padding-top:10px;">
        ...
        <h4>
            <a href="#/altmain#" v-on:click='addEvent = !addEvent' style="padding:10px;">+ Event</a>
            <a href="#/altmain#" v-on:click='addComment = !addComment'> + Comment</el-button>
        </h4>
      <br/>
    </el-col>
